...
const UNIVERSE = [
  ...
  // --- small / mid caps (20y history) for cross-sectional + liquidity breadth ---
  ...
  ["DIOD", "Diodes Inc", "Semiconductors"],
  ...
  ["SKX", "Skechers", "Consumer Discretionary"],
  ...
  ["DDS", "Dillard's", "Consumer Discretionary"],
  ["MASI", "Masimo", "Healthcare"],
